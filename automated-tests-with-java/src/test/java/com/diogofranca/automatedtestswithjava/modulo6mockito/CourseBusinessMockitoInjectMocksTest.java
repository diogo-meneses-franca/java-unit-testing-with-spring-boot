...
// Ativa o suporte do Mockito para a classe de teste, permitindo a injeção automática de mocks
@ExtendWith(MockitoExtension.class)
public class CourseBusinessMockitoInjectMocksTest {

	// Cria um mock da classe especificada para simular o comportamento em testes
	@Mock
	CourseService mockService;

	/*
	É o mesmo que CourseBusiness business = new CourseBusiness(mockservice);
	A annotation @InjectMocks cria uma instancia da classe e injeta os mocks anotados
	com @Mock nela.
	 */
	@InjectMocks
	CourseBusiness business;

	/*@Captor é usado para capturar argumentos passados para métodos em mocks,
	permitindo verificar se foram chamados com os valores corretos durante os testes.
	 */
